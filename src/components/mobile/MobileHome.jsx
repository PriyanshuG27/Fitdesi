...
export const MobileHome = () => {
  ...
  const { planLoading, currentPlan, planDays, weekId, planError } = usePlanStore();
  ...
  useEffect(() => {
    if (uid && profile?.onboardingComplete === true && currentPlan === null && !planLoading && !planError && !hasAutoGenerated) {
      setHasAutoGenerated(true);
      generatePlan();
    }
  }, [uid, profile?.onboardingComplete, currentPlan, planLoading, planError, hasAutoGenerated, generatePlan]);
