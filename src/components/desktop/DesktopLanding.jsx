...
export const DesktopLanding = () => {
  return (
    <div className="min-h-screen bg-bg-base text-text-primary p-8 flex flex-col justify-center items-center max-w-4xl mx-auto space-y-6">
      <h1 className="text-display text-6xl text-primary font-bold">Zenkai</h1>
      <p className="text-body text-xl text-text-secondary text-center max-w-2xl">
        The ultimate AI-powered athletic workout logging and comeback planning system. Tailored to your equipment, medical constraints, and target capacity. (Desktop view)
      </p>
